...
class DemoMotion{
	...
	boolean overOrigin (float x, float y){
		return dist(this.a.pos.x, this.a.pos.y, x, y)<50;
	}

	void updatePosOrigin(float x, float y){
		this.a.pos = new PVector(x, y);
		this.m.setOrigin(x, y);
	}
	...
	boolean overTarget (float x, float y){
		return dist(this.b.pos.x, this.b.pos.y, x, y)<50;
	}

	void updatePosTarget(float x, float y){
		this.b.pos = new PVector(x, y);
		this.m.setTarget(x, y);
	}
