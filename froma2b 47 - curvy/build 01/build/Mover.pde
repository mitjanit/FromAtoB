	...
	void setMotion(int tipus, float a, float b){
		switch(tipus){
			...
			case Motion.HYPOCYCLOID: 		
				motion = new HypocycloidMotion(origin, target, (int)a, (int)b);
				break; 

			case Motion.LISSAJOUS: 		
				motion = new LissajousMotion(origin, target, (int)a, (int)b);
				break; 

			case Motion.TRICUSPOID: 		
				motion = new TricuspoidMotion(origin, target, (int)a, (int)b);
				break; 

			case Motion.PIRIFORM: 		
				motion = new PiriformMotion(origin, target, (int)a, (int)b);
				break; 

			case Motion.EPITROCHOID: 		
				motion = new EpitrochoidMotion(origin, target, (int)a, (int)b);
				break; 

			case Motion.BICORN: 		
				motion = new BicornMotion(origin, target, (int)a, (int)b);
				break; 

			case Motion.BOOMERAN: 		
				motion = new BoomeranMotion(origin, target, (int)a, (int)b);
				break; 
			...
			case Motion.PEAK: 		
				motion = new PeakMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.ROUNDED_PEAK: 		
				motion = new RoundedPeakMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.SUPERFORMULA: 		
				motion = new SuperformulaMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.HEXASTRIP: 		
				motion = new HexaMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.KOCH_CURVE: 		
				motion = new KochCurveMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.SIERPINSKI_CURVE: 		
				motion = new SierpinskiCurveMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.HILBERT_CURVE: 		
				motion = new HilbertCurveMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.DRAGON_CURVE: 		
				motion = new DragonCurveMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.SNOW_CURVE: 		
				motion = new SnowCurveMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.LEVY_CURVE: 		
				motion = new LevyCurveMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.QUADRATIC_GOSPER: 		
				motion = new QuadraticGosperMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.BUBBLE_ARC: 		
				motion = new BubbleArcMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.ZIG_ZAG: 		
				motion = new ZigZagMotion(origin, target, (int)a, (int)b);
				break;

			case Motion.SNAKE: 		
				motion = new SnakeMotion(origin, target, (int)a, (int)b);
				break;
		}
	}
