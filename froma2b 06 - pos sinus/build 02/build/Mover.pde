...
class Mover {
	...
	void setMotion(int tipus, float a, float b, float c){
		switch(tipus){
			...
			case Motion.SINUS:
				motion = new SinusMotion(origin, target, (int)a, (int)b, (int)c);
				break;

			case Motion.ABS_SINUS:
				motion = new AbsSinusMotion(origin, target, (int)a, (int)b, (int)c);
				break;

			case Motion.POS_SINUS:
				motion = new PosSinusMotion(origin, target, (int)a, (int)b, (int)c);
				break;
